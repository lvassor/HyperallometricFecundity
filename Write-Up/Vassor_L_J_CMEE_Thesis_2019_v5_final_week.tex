...
\section{Introduction}\thispagestyle{plain}
    ...
    \begin{center}
        ...
        \begin{minipage}{0.45\linewidth}
            ...
            \captionof{figure}{The logistic growth curve results from the low metabolic costs incurred at small body masses, giving rise to a fast growth rate at small sizes which slows as mass increases. Determinate growers reach an asymptotic size within their lifetime, where growth rate = 0.}
        \end{minipage}
    \end{center}
