...
\title{Title Block: Explicitly Accounting for Resource Supply and Hyperallometric Fecundity Scaling in Ontogenetic Growth Models}

\author{AUTHOR BLOCK e.g.\ \mainauthor{Luke Vassor},\Tsup{1} Tom Clegg,\Tsup{2} Diego Barneche,\Tsup{3} Van Savage,\Tsup{1} Samraat Pawar
