...
% \draw (701,71) node   {$0$};
% Text Node
\draw (33,103) node [rotate=-270.08] [align=left] {Survivorship, $l(t)$};
% Text Node
\draw (150,200) node  [align=left] {Time};
\draw (63,190) node  [align=left] {$\alpha$};

% \draw (180,90) node [align=left] {$R_0 = \int_{\alpha}^{\infty}l_{t}b_{t} dt$};
